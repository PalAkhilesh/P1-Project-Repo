...
<html lang="en">
  <head>
    ...
    <title>TFMS - Login</title>
  </head>
  <body style="overflow: hidden;">
    <div class="content" style="height: 93vh">
      <h3>
        Welcome to <span style="font-weight: 700">Code Hub</span> Institute
      </h3>
      <div class="container">
        <div class="row">
          <div class="col-md-6 order-md-2">
            <img
              src="assets/img/login-animate.svg"
              alt="Image"
              class="img-fluid"
            />
          </div>
      ...
      <footer
        ...
        "
      >
        @Copyright | Code Hub | 2022- All Right Reserved.
      </footer>
    </div>
